...
ALTER TABLE USER_ACCOUNT_TABLE ADD CONSTRAINT USER_ACCOUNT_TABLE_fk0 FOREIGN KEY (USER_KEY) REFERENCES USER_INFO_TABLE(USER_KEY);
 

ALTER TABLE USER_GROUP_TABLE ADD CONSTRAINT USER_GROUP_TABLE_fk0 FOREIGN KEY (USER_KEY) REFERENCES USER_INFO_TABLE(USER_KEY);
...
ALTER TABLE FEATURE_COMPONENT_TABLE ADD CONSTRAINT FEATURE_COMPONENT_TABLE_fk0 FOREIGN KEY (FEATURE_ID) REFERENCES FEATURE_TABLE(FEATURE_KEY);


ALTER TABLE USER_ROLE_TABLE ADD CONSTRAINT USER_ROLE_TABLE_fk0 FOREIGN KEY (USER_KEY) REFERENCES USER_INFO_TABLE(USER_KEY);
ALTER TABLE USER_ROLE_TABLE ADD CONSTRAINT USER_ROLE_TABLE_fk1 FOREIGN KEY (ROLE_KEY) REFERENCES ROLE_TABLE(ROLE_KEY);

ALTER TABLE USER_AFFILIATION_TABLE ADD CONSTRAINT USER_AFFILIATION_TABLE_fk0 FOREIGN KEY (USER_KEY) REFERENCES USER_INFO_TABLE(USER_KEY);
...
ALTER TABLE USER_VISIT_HISTORY_TABLE ADD CONSTRAINT USER_VISIT_HISTORY_TABLE_fk0 FOREIGN KEY (USER_KEY) REFERENCES USER_INFO_TABLE(USER_KEY);
