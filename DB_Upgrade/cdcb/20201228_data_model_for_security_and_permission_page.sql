...
CREATE TABLE GROUP_FIELD_TABLE (
	GROUP_KEY INT NOT NULL,
	FIELD_KEY INT NOT NULL,
	CREATED_TIME TIMESTAMP  NOT NULL DEFAULT  CURRENT TIMESTAMP,
	MODIFIED_TIME TIMESTAMP NOT NULL DEFAULT  CURRENT TIMESTAMP,
	MODIFIED_BY VARCHAR(50) NULL,
	constraint GROUP_FIELD_TABLE_PK PRIMARY KEY (GROUP_KEY,FIELD_KEY)
);


CREATE TABLE ROLE_FIELD_TABLE (
	ROLE_KEY INT NOT NULL,
	FIELD_KEY INT NOT NULL,
	CREATED_TIME TIMESTAMP  NOT NULL DEFAULT  CURRENT TIMESTAMP,
	MODIFIED_TIME TIMESTAMP NOT NULL DEFAULT  CURRENT TIMESTAMP,
	MODIFIED_BY VARCHAR(50) NULL,
	constraint ROLE_FIELD_TABLE_PK PRIMARY KEY (ROLE_KEY,FIELD_KEY)
);
