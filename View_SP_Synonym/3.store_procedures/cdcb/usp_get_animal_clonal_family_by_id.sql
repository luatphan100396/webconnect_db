...
BEGIN
	...
	IF (select fn_check_user_name_has_permission_on_component(@USER_KEY,'Queries >> Cattle - ID/Pedigree','Clonal Family Members of (DNA ID)') from sysibm.sysdummy1)=0 THEN
