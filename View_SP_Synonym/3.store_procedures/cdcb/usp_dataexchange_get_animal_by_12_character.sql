...
--Output:
--        +Ds1: Table with ANIM_KEY,ANIMAL_ID,SEX_CODE,LONG_NAME,PREFERED_ID,SRC,MODIFY_DATE,REG,INPUT
   ...
   INSERT INTO SESSION.TmpAnimalLists_Alias
	...
	SELECT  
		 ...
		 LEFT JOIN ID_XREF_TABLE id
			  ON t.INT_ID = id.INT_ID
			  AND t.ANIM_KEY=id.ANIM_KEY
	...
	SELECT       
				 ...
				 ,dam.PREFERRED_CODE AS PREFERED_ID
			...
			LEFT JOIN ANIM_NAME_TABLE aname
			    ON aname.INT_ID = t.INT_ID 
			    AND t.SEX_CODE =aname.SEX_CODE
			with ur;
