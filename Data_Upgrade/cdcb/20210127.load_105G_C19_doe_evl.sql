...
db2 load from /home/db2inst1/Data/Goat/1912/105G.C19 of del insert into DOE_105_C19
*/

CREATE TABLE TMP_DOE_EVL_TABLE AS
(
...
ALTER TABLE TMP_DOE_EVL_TABLE ADD constraint TMP_DOE_EVL_TABLE_PK primary key (ANIM_KEY,EVAL_PDATE);

insert into TMP_DOE_EVL_TABLE
select 
id.ANIM_KEY,
21884 as  EVAL_PDATE,
...
--delete from DOE_EVL_TABLE immediate;

INSERT INTO DOE_EVL_TABLE
(
  ANIM_KEY
 ,EVAL_PDATE
 ,INT_ID
...
ANIM_KEY
 ...
 ,REGIS_STATUS_CODE
 ,LAST_DRPC_CODE
 ,CAST(CAST(NULLIF(TRIM(GM_AMT),'') AS INT) AS VARCHAR(10)) AS GM_AMT
 ,LH_STATE_CODE
 ,LH_COUNTRY_CODE
 ...
 ,REC_IN_PROGRESS_CODE
 ,INBRD_PCT
 ,CAST(CAST(NULLIF(TRIM(SUM_LACT_WGT_QTY),'') AS INT) AS VARCHAR(10))SUM_LACT_WGT_QTY
 ,NM_PCTL
 ,YLD_REL_PCT
 ,PTA_MF_REL_PCT 
 ,PTA_PRO_REL_PCT
 ...
 ,PTA_SCS_REL_PCT
 ,NM_REL_PCT
 ,CAST(CAST(NULLIF(TRIM(NM_AMT),'') AS INT) AS VARCHAR(10)) AS NM_AMT
 ,FH_STATE_CODE
 ,FH_COUNTRY_CODE  
 ,FH_HERD_NUMBER  
 ,CAST(CAST(NULLIF(TRIM(FM_AMT),'') AS INT) AS VARCHAR(10)) AS FM_AMT
 ,CAST(CAST(NULLIF(TRIM(MF_DAU_QTY),'') AS INT) AS VARCHAR(10)) AS MF_DAU_QTY  
 ,CAST(CAST(NULLIF(TRIM(PRO_DAU_QTY),'') AS INT) AS VARCHAR(10)) AS PRO_DAU_QTY 
 ,MF_HERDS_QTY
 ,PRO_HERDS_QTY
 ,GENOMICS_IND
 ,CAST(CAST(NULLIF(TRIM(PARENT_CONTRIBUTE),'') AS INT) AS VARCHAR(10)) AS PARENT_CONTRIBUTE
 ,CAST(CAST(NULLIF(TRIM(PRO_OVERAL_CONTRIBUTE),'') AS INT) AS VARCHAR(10)) AS PRO_OVERAL_CONTRIBUTE
 ,PL_AGE_WGT
 ,LACT_QTY
 ,PRO_LACT_QTY
 ,CAST(CAST(NULLIF(TRIM(FUTURE_DAU_INBRD_PCT),'') AS INT) AS VARCHAR(10)) AS FUTURE_DAU_INBRD_PCT
 ,CAST(CAST(NULLIF(TRIM(MF_AVG_LACT_QTY),'') AS INT) AS VARCHAR(10)) AS MF_AVG_LACT_QTY
  ,CAST(CAST(NULLIF(TRIM(PRO_AVG_LACT_QTY),'') AS INT) AS VARCHAR(10)) AS PRO_AVG_LACT_QTY
 ,CAST(CAST(NULLIF(TRIM(CM_AMT),'') AS INT) AS VARCHAR(10)) AS CM_AMT
 ,CAST(CAST(NULLIF(TRIM(STD_MLK_QTY),'') AS INT) AS VARCHAR(10)) AS STD_MLK_QTY
 ,CAST(CAST(NULLIF(TRIM(STD_FAT_QTY),'') AS INT) AS VARCHAR(10)) AS STD_FAT_QTY
 ,CAST(CAST(NULLIF(TRIM(STD_MP_QTY),'') AS INT) AS VARCHAR(10)) AS STD_MP_QTY
 ,CAST(CAST(NULLIF(TRIM(STD_PRO_QTY),'') AS INT) AS VARCHAR(10)) AS STD_PRO_QTY
 ,COW_TOTAL_IN_MLK
 ,STD_SCS_QTY
 ,STD_DPR_QTY
 ,PTA_DPR_REL_PCT
 ...
 ,PTA_EFC_REL_PCT
 ,PA_EFC_REL_PCT 
 ,FLOAT2CHAR(NULLIF(TRIM(PTA_MLK_QTY),'')*1,1)AS PTA_MLK_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PTA_FAT_QTY),'')*1,1) AS PTA_FAT_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PTA_PRO_QTY),'')*1,1) AS PTA_PRO_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PTA_PL_QTY),'')*0.1,0.1) AS PTA_PL_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PTA_SCS_QTY),'')*0.01,0.01) AS PTA_SCS_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PTA_DPR_QTY),'')*0.1,0.1) AS PTA_DPR_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PTA_HCR_QTY),'')*0.1,0.1) AS PTA_HCR_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PTA_CCR_QTY),'')*0.1,0.1) AS PTA_CCR_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PTA_LIV_QTY),'')*0.1,0.1) AS PTA_LIV_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PTA_GL_QTY),'')*0.1,0.1) AS PTA_GL_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PTA_MFV_QTY),'')*0.1,0.1) AS PTA_MFV_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PTA_DAB_QTY),'')*0.1,0.1) AS PTA_DAB_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PTA_KET_QTY),'')*0.1,0.1) AS PTA_KET_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PTA_MAS_QTY),'')*0.1,0.1) AS PTA_MAS_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PTA_MET_QTY),'')*0.1,0.1) AS PTA_MET_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PTA_RPL_QTY),'')*0.1,0.1) AS PTA_RPL_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PTA_EFC_QTY),'')*0.1,0.1) AS PTA_EFC_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PTA_FAT_PCT),'')*0.01,0.01) AS PTA_FAT_PCT
 ,FLOAT2CHAR(NULLIF(TRIM(PTA_PRO_PCT),'')*0.01,0.01) AS PTA_PRO_PCT 
 ,FLOAT2CHAR(NULLIF(TRIM(PA_MLK_QTY),'')*1,1) AS PA_MLK_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PA_FAT_QTY),'')*1,1) AS PA_FAT_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PA_PRO_QTY),'')*1,1) AS PA_PRO_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PA_PL_QTY),'')*0.1,0.1) AS PA_PL_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PA_SCS_QTY),'')*0.01,0.01) AS PA_SCS_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PA_DPR_QTY),'')*0.1,0.1) AS PA_DPR_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PA_HCR_QTY),'')*0.1,0.1) AS PA_HCR_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PA_CCR_QTY),'')*0.1,0.1) AS PA_CCR_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PA_LIV_QTY),'')*0.1,0.1) AS PA_LIV_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PA_GL_QTY),'')*0.1,0.1) AS PA_GL_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PA_MFV_QTY),'')*0.1,0.1) AS PA_MFV_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PA_DAB_QTY),'')*0.1,0.1) AS PA_DAB_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PA_KET_QTY),'')*0.1,0.1) AS PA_KET_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PA_MAS_QTY),'')*0.1,0.1) AS PA_MET_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PA_MET_QTY),'')*0.1,0.1) AS PA_MET_QTY
 ,FLOAT2CHAR(NULLIF(TRIM(PA_RPL_QTY),'')*0.1,0.1) AS PA_RPL_QTY 
 ,FLOAT2CHAR(NULLIF(TRIM(PA_EFC_QTY),'')*0.1,0.1) AS PA_EFC_QTY
 
 FROM TMP_DOE_EVL_TABLE;

UPDATE DOE_EVL_TABLE SET LH_HERD_NUMBER = NULL WHERE LH_HERD_NUMBER = '0000';
UPDATE DOE_EVL_TABLE SET LH_DIM = NULL WHERE LH_DIM = '0';
UPDATE DOE_EVL_TABLE SET LH_HERD_NUMBER = CAST(CAST(LH_HERD_NUMBER AS INT) AS VARCHAR(10))